...
from pyeitaa.raw.core.primitives import Int, Bool, String, Vector
...
class Config(TLObject):
    """This object is a constructor of the base type :obj:`~pyeitaa.raw.base.Config`.
    ...
    Parameters:
        ...
        schedule_period_foreground_ms: ``int`` ``32-bit``
        schedule_period_background_ms: ``int`` ``32-bit``
        schedule_period_background_delay_ms: ``int`` ``32-bit``
        upload_chunk_size_kb: ``int`` ``32-bit``
        download_chunk_size_kb: ``int`` ``32-bit``
    ...
    def __init__(self, *, date: int, expires: int, test_mode: bool, this_dc: int, dc_options: List["raw.base.DcOption"], dc_txt_domain_name: str, chat_size_max: int, megagroup_size_max: int, forwarded_count_max: int, online_update_period_ms: int, offline_blur_timeout_ms: int, offline_idle_timeout_ms: int, online_cloud_timeout_ms: int, notify_cloud_delay_ms: int, notify_default_delay_ms: int, push_chat_period_ms: int, push_chat_limit: int, saved_gifs_limit: int, edit_time_limit: int, revoke_time_limit: int, revoke_pm_time_limit: int, rating_e_decay: int, stickers_recent_limit: int, stickers_faved_limit: int, channels_read_media_period: int, pinned_dialogs_count_max: int, pinned_infolder_count_max: int, call_receive_timeout_ms: int, call_ring_timeout_ms: int, call_connect_timeout_ms: int, call_packet_timeout_ms: int, me_url_prefix: str, caption_length_max: int, message_length_max: int, webfile_dc_id: int, schedule_period_foreground_ms: int, schedule_period_background_ms: int, schedule_period_background_delay_ms: int, upload_chunk_size_kb: int, download_chunk_size_kb: int, phonecalls_enabled: Optional[bool] = None, default_p2p_contacts: Optional[bool] = None, preload_featured_stickers: Optional[bool] = None, ignore_phone_entities: Optional[bool] = None, revoke_pm_inbox: Optional[bool] = None, blocked_mode: Optional[bool] = None, pfs_enabled: Optional[bool] = None, tmp_sessions: Optional[int] = None, autoupdate_url_prefix: Optional[str] = None, gif_search_username: Optional[str] = None, venue_search_username: Optional[str] = None, img_search_username: Optional[str] = None, static_maps_provider: Optional[str] = None, suggested_lang_code: Optional[str] = None, lang_pack_version: Optional[int] = None, base_lang_pack_version: Optional[int] = None) -> None:
        ...
        self.schedule_period_foreground_ms = schedule_period_foreground_ms  # int
        self.schedule_period_background_ms = schedule_period_background_ms  # int
        self.schedule_period_background_delay_ms = schedule_period_background_delay_ms  # int
        self.upload_chunk_size_kb = upload_chunk_size_kb  # int
        self.download_chunk_size_kb = download_chunk_size_kb  # int
    ...
    def write(self) -> bytes:
        ...
        data.write(Int(self.schedule_period_foreground_ms))
        
        data.write(Int(self.schedule_period_background_ms))
        
        data.write(Int(self.schedule_period_background_delay_ms))
        
        data.write(Int(self.upload_chunk_size_kb))
        
        data.write(Int(self.download_chunk_size_kb))
