...
class ParticipantVersionOutdated(BadRequest):
    """The other participant is using an outdated Eitaa app version"""
...
class PhoneNumberBanned(BadRequest):
    """The phone number is banned from Eitaa and cannot be used"""
...
class PhotoSaveFileInvalid(BadRequest):
    """The photo you tried to send cannot be saved by Eitaa. A reason may be that it exceeds 10 MB. Try resizing it locally"""
...
class WebpageCurlFailed(BadRequest):
    """Eitaa server could not fetch the provided URL"""
